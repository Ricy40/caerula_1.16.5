...
public abstract class CaerulaWaterCreatureEntity extends WaterMobEntity {
    private static final DataParameter<Boolean> FROM_BUCKET = EntityDataManager.defineId(CaerulaWaterCreatureEntity.class, DataSerializers.BOOLEAN);

    public CaerulaWaterCreatureEntity(EntityType<? extends CaerulaWaterCreatureEntity> p_i48855_1_, World p_i48855_2_) {
        super(p_i48855_1_, p_i48855_2_);
        this.moveControl = new CaerulaWaterCreatureEntity.MoveHelperController(this);
    }
    ...
    public static boolean checkFishSpawnRules(EntityType<? extends CaerulaWaterCreatureEntity> p_223363_0_, IWorld p_223363_1_, SpawnReason p_223363_2_, BlockPos p_223363_3_, Random p_223363_4_) {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(4, new CaerulaWaterCreatureEntity.SwimGoal(this));
    }
    ...
    static class MoveHelperController extends MovementController {
        private final CaerulaWaterCreatureEntity fish;

        MoveHelperController(CaerulaWaterCreatureEntity p_i48857_1_) {
            super(p_i48857_1_);
    ...
    static class SwimGoal extends RandomSwimmingGoal {
        ...
        public SwimGoal(CaerulaWaterCreatureEntity entityIn) {
