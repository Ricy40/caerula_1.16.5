...
public class ConfiguredFeaturesInit {
    ...
    public static final ConfiguredFeature<?, ?> RED_SEAGRASS_FIELDS_FEATURE = FeaturesInit.RED_SEAGRASS_FEATURE.get().configured(
            new ProbabilityConfig(0.3F)).count(80).decorated(Features.Placements.TOP_SOLID_HEIGHTMAP_SQUARE);
