...
public abstract class FeaturesInit {
    ...
    public static final RegistryObject<RedSeaGrassFeature> RED_SEAGRASS_FEATURE = FEATURES.register("red_seagrass_feature", () -> new RedSeaGrassFeature(ProbabilityConfig.CODEC));
